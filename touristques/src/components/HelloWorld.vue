    ...
    data() {
      return {
        ...
        questions: [
          ...
          new QuestionModel({
            id: 'first_name',
            // tagline: 'Hi! Welcome to our questionaire 😊',
          ...
          new QuestionModel({
            id: 'first_name',
            tagline: 'What are your travel details?',
            title: 'Arrival date',
            type: QuestionType.Text,
            required: true,
          ...
          new QuestionModel({
            ...
            title: 'What is your preferred time of day to guide:',
            helpTextShow: false,
            type: QuestionType.MultipleChoice,
            multiple: false,
            allowOther: true,
            ...
            options: [
              ...
              new ChoiceOption({
                label: "Anytime of the day works"
              })
            ]
          }),new QuestionModel({
            id: 'multiple_choice',
            title: 'What will your fee structure be?:',
            helpTextShow: false,
            type: QuestionType.MultipleChoice,
            multiple: false,
            allowOther: true,
            ...
            id: 'multiple_choice',
            title: 'How can the guide contact you:',
            helpTextShow: false,
            type: QuestionType.MultipleChoice,
            multiple: false,
            allowOther: true,
